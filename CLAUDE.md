...
# BluePilot Codebase Guide

This guide is maintained in `.ruler/AGENTS.md`; regenerate agent instructions with `mise run agents:generate` instead of editing generated copies.
