...
DESCRIPTIONS = {
  "OpenpilotEnabledToggle": tr_noop(
    "Use the bluepilot system for adaptive cruise control and lane keep driver assistance. " +
    "Your attention is required at all times to use this feature."
  ),
  "DisengageOnAccelerator": tr_noop("When enabled, pressing the accelerator pedal will disengage bluepilot."),
  "LongitudinalPersonality": tr_noop(
    "Standard is recommended. In aggressive mode, bluepilot will follow lead cars closer and be more aggressive with the gas and brake. " +
    "In relaxed mode bluepilot will stay further away from lead cars. On supported cars, you can cycle through these personalities with " +
  ...
  "AlwaysOnDM": tr_noop("Enable driver monitoring even when bluepilot is not engaged."),
...
class TogglesLayout(Widget):
  ...
  def _update_toggles(self) -> None:
    ...
    e2e_description = tr(
      ...
      "Let the driving model control the gas and brakes. bluepilot will drive as it thinks a human would, including stopping for red lights and stop signs. " +
