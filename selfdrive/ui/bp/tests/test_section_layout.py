...
def test_reopen_menu_after_expanding_description(monkeypatch, nested, inline):
  ...
  item = cls('Low-Speed Angle Factor', description='Steering factor explanation', **kwargs)
