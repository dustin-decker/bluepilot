...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"FordSmallSignalFactor", {PERSISTENT | BACKUP, FLOAT, "1.0"}},   // sub-knee (|k| < 0.0007) gain lift at speed — compensates PSCM small-angle under-delivery (measured 0.75-0.85); 1.0 = stock
