...
def test_collect_never_reads_full() -> None:
...
def test_collect_progresses() -> None:
...
def test_verify_progresses_within_band() -> None:
...
def test_scaled_render_dimensions_preserve_default_size() -> None:
  default = AutoCalBars()
